...
import com.twan.projectboard.service.ArticleService;
import com.twan.projectboard.service.PaginationService;
import com.twan.projectboard.util.FormDataEncoder;
...
class ArticleControllerTest {
    ...
    @WithMockUser
    @DisplayName("[view] [GET] 게시글 상세 페이지 - 정상, 인증된 사용자")
    @Test
    ...
    @DisplayName("[view] [GET] 게시글 해시태그 검색 페이지 - 정상, 해시태그 입력")
    @Test
    ...
    @DisplayName("[view] [GET] 게시글 리스트 페이지 - 검색어와 함께")
    @Test
