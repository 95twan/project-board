...
class JpaRepositoryTest {
    ...
    void givenTestData_whenUpdating_thenWorksFine() {
        ...
        Hashtag updatedHashtag = Hashtag.of("updatedHashtag");
        ...
        // Then
        assertThat(updatedArticle.getHashtags())
                .hasSize(1)
    ...
    void givenParentComment_whenSaving_thenInsertsChildComment() {
        ...
        int childCommentCount = parentComment.getChildComments().size();
    ...
    void givenArticleCommentHavingChildComments_whenDeletingParentComment_thenDeletesEveryComment() {
        ...
        ArticleComment parentComment = articleCommentRepository.getReferenceById(1L);
        long previousArticleCommentCount = articleCommentRepository.count();
        long childCommentCount = parentComment.getChildComments().size();

        // When
        articleCommentRepository.delete(parentComment);

        // Then
        assertThat(articleCommentRepository.count()).isEqualTo(previousArticleCommentCount - (1 + childCommentCount)); // 테스트 댓글 + 대댓글 4개
    }
