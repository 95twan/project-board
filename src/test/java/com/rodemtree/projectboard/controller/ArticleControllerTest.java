...
import com.rodemtree.projectboard.dto.HashtagDto;
...
import com.rodemtree.projectboard.util.FormDataEncoder;
...
class ArticleControllerTest {
    ...
    @Test
    void givenSearchKeyword_whenRequestSearchingArticlesView_thenReturnsArticlesView() throws Exception {
        // Given
    ...
    @Test
    void givenNothing_whenRequestArticleSearchHashtagView_thenReturnsArticleSearchHashtagView() throws Exception {
        // Given
    ...
    @Test
    void givenHashtag_whenRequestArticleSearchHashtagView_thenReturnsArticleSearchHashtagView() throws Exception {
        // Given
        String hashtag = "#java";
        List<String> hashtags = List.of("#java", "#spring", "#boot");
